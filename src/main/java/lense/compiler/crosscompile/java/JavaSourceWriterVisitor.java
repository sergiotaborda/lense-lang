                ...
                for (AstNode n : deque) {
                    ...
                    if (n instanceof StringValue) {
                        ...
                        if (n instanceof MethodInvocationNode) {
                        	...
                        	if (v.getVariableInfo().getTypeVariable().getTypeDefinition().getName().equals("lense.core.lang.String")) {
                ...
                if (ctr.isNative()) {
                	if (ctr.getBlock() != null) {
                		TreeTransverser.transverse(ctr.getBlock(), this);
                		 ...
                		 writer.println("{ throw new java.lang.UnsupportedOperationException(\"Native method not implemented natively\"); // native \n }");
                	}
