 ...
 * 
 */
public class Ecma6JavascriptWriterVisitor implements Visitor<AstNode> {
	 ...
	 * @param writer
	 */
	public Ecma6JavascriptWriterVisitor(PrintWriter writer) {
		this.writer = writer;
	}
	...
	public VisitorNext visitBeforeChildren(AstNode node) {
		try {
			if (node instanceof NoneValue) {
				...
				Ecma6JavascriptWriterVisitor visitor = new Ecma6JavascriptWriterVisitor(sp);
