...
public class LenseTypeSystem {
    ...
    private LenseTypeSystem() {
        ...
        LenseTypeDefinition sequence = register(new FundamentalLenseTypeDefinition("lense.core.collections.Sequence",
                LenseUnitKind.Interface, iterable));
        ...
        sequence.addIndexer(new DeclaringTypeBoundedTypeVariable(sequence, 0, "T", Variance.Covariant), true, true,
                new TypeVariable[] { new FixedTypeVariable(natural) });
