...
classMemberDeclaration.setRule(fieldDeclaration.or(methodDeclaration.or(constructorDeclaration.or(abstractPropertyDeclaration.or(propertyDeclaration.or(indexerDeclaration.or(abstractIndexerDeclaration)))))));
abstractPropertyDeclaration.setRule(annotations.add(type).add(Identifier.instance()).add(abstractPropertyHead).or(type.add(Identifier.instance()).add(abstractPropertyHead)));
...
abstractPropertyMember.setRule(annotations.add(Terminal.of("set")).add(Terminal.of(";")).or(Terminal.of("set").add(Terminal.of(";"))).or(annotations.add(Terminal.of("get")).add(Terminal.of(";")).or(Terminal.of("get").add(Terminal.of(";")))));
propertyDeclaration.setRule(annotations.add(type).add(Identifier.instance()).add(propertyDeclarationHead).or(type.add(Identifier.instance()).add(propertyDeclarationHead)));
...
propertyMember.setRule(annotations.add(Terminal.of("get")).add(Terminal.of("{")).add(blockStatements).add(Terminal.of("}")).or(Terminal.of("get").add(Terminal.of("{")).add(blockStatements).add(Terminal.of("}"))).or(annotations.add(Terminal.of("set")).add(Terminal.of("(")).add(Identifier.instance()).add(Terminal.of(")")).add(Terminal.of("{")).add(blockStatements).add(Terminal.of("}")).or(Terminal.of("set").add(Terminal.of("(")).add(Identifier.instance()).add(Terminal.of(")")).add(Terminal.of("{")).add(blockStatements).add(Terminal.of("}")))));
indexerDeclaration.setRule(annotations.add(type).add(Terminal.of("[")).add(formalParameterList).add(Terminal.of("]")).add(propertyDeclarationHead).or(type.add(Terminal.of("[")).add(formalParameterList).add(Terminal.of("]")).add(propertyDeclarationHead)));
abstractIndexerDeclaration.setRule(annotations.add(type).add(Terminal.of("[")).add(formalParameterList).add(Terminal.of("]")).add(abstractPropertyHead).or(type.add(Terminal.of("[")).add(formalParameterList).add(Terminal.of("]")).add(abstractPropertyHead)));
