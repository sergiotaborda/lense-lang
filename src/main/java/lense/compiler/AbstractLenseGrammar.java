...
public abstract class AbstractLenseGrammar extends AbstractGrammar {
    ...
    protected NonTerminal defineGrammar() {
        ...
        NonTerminal visibilityModifier = addNonTerminal(NonTerminal.of("visibilityModifier"));
        NonTerminal varianceModifier = addNonTerminal(NonTerminal.of("varianceModifier"));
        NonTerminal implementationModifiers = addNonTerminal(NonTerminal.of("implementationModifiers"));
        NonTerminal implementationModifier = addNonTerminal(NonTerminal.of("implementationModifier"));
        ...
        NonTerminal objectDeclaration = addNonTerminal(NonTerminal.of("objectDeclaration"));
        ...
        NonTerminal abstractPropertyDeclaration = addNonTerminal(NonTerminal.of("abstractPropertyDeclaration"));
        NonTerminal abstractPropertyHead = addNonTerminal(NonTerminal.of("abstractPropertyHead"));
        NonTerminal abstractPropertyMembers = addNonTerminal(NonTerminal.of("abstractPropertyMembers"));
        NonTerminal abstractPropertyMember = addNonTerminal(NonTerminal.of("abstractPropertyMember"));
        ...
        NonTerminal constructorFormalParameterList = addNonTerminal(NonTerminal.of("constructorFormalParameterList"));
        NonTerminal constructorFormalParameter = addNonTerminal(NonTerminal.of("constructorFormalParameter"));
        NonTerminal constructorExtension = addNonTerminal(NonTerminal.of("constructorExtension"));
        NonTerminal construtorBlock = addNonTerminal(NonTerminal.of("construtorBlock"));
        ...
        NonTerminal propertyDeclaration = addNonTerminal(NonTerminal.of("propertyDeclaration"));
        NonTerminal typedPropertyDeclaration = addNonTerminal(NonTerminal.of("typedPropertyDeclaration"));
        NonTerminal nonTypedPropertyDeclaration = addNonTerminal(NonTerminal.of("nonTypedPropertyDeclaration"));
        NonTerminal propertyDeclarationHead = addNonTerminal(NonTerminal.of("propertyDeclarationHead"));
        NonTerminal propertyMembers = addNonTerminal(NonTerminal.of("propertyMembers"));
        NonTerminal propertyMember = addNonTerminal(NonTerminal.of("propertyMember"));
        NonTerminal indexerDeclaration = addNonTerminal(NonTerminal.of("indexerDeclaration"));
        NonTerminal abstractIndexerDeclaration = addNonTerminal(NonTerminal.of("abstractIndexerDeclaration"));
        NonTerminal type = addNonTerminal(NonTerminal.of("type"));
        NonTerminal nonNullType = addNonTerminal(NonTerminal.of("nonNullType"));
        ...
        NonTerminal elseOptions = addNonTerminal(NonTerminal.of("elseOptions"));
        ...
        NonTerminal typeObject = addNonTerminal(NonTerminal.of("typeObject"));
        ...
        NonTerminal powerOperator = addNonTerminal(NonTerminal.of("powerOperator"));
        NonTerminal rangeExpression = addNonTerminal(NonTerminal.of("rangeExpression"));
        NonTerminal intervalStart = addNonTerminal(NonTerminal.of("intervalStart"));
        NonTerminal intervalEnd = addNonTerminal(NonTerminal.of("intervalEnd"));
        ...
        implementationModifier.setRule(Terminal.of("abstract").or(Terminal.of("native").or(Terminal.of("sealed"))));
        ...
        typeDeclaration.setRule(classDeclaration.or(interfaceDeclaration.or(objectDeclaration)));
        classDeclaration.setRule(annotations.add(visibilityModifier).add(implementationModifiers).add(Terminal.of("class")).add(qualifiedName).add(genericTypesDeclaration).add(superDeclaration).add(implementsInterfaces).add(classBody).or(annotations.add(visibilityModifier).add(implementationModifiers).add(Terminal.of("class")).add(qualifiedName).add(genericTypesDeclaration).add(superDeclaration).add(classBody)).or(annotations.add(visibilityModifier).add(Terminal.of("class")).add(qualifiedName).add(genericTypesDeclaration).add(superDeclaration).add(implementsInterfaces).add(classBody)).or(annotations.add(visibilityModifier).add(Terminal.of("class")).add(qualifiedName).add(genericTypesDeclaration).add(superDeclaration).add(classBody)).or(annotations.add(implementationModifiers).add(Terminal.of("class")).add(qualifiedName).add(genericTypesDeclaration).add(superDeclaration).add(implementsInterfaces).add(classBody)).or(annotations.add(implementationModifiers).add(Terminal.of("class")).add(qualifiedName).add(genericTypesDeclaration).add(superDeclaration).add(classBody)).or(annotations.add(Terminal.of("class")).add(qualifiedName).add(genericTypesDeclaration).add(superDeclaration).add(implementsInterfaces).add(classBody)).or(annotations.add(Terminal.of("class")).add(qualifiedName).add(genericTypesDeclaration).add(superDeclaration).add(classBody)).or(visibilityModifier.add(implementationModifiers).add(Terminal.of("class")).add(qualifiedName).add(genericTypesDeclaration).add(superDeclaration).add(implementsInterfaces).add(classBody)).or(visibilityModifier.add(implementationModifiers).add(Terminal.of("class")).add(qualifiedName).add(genericTypesDeclaration).add(superDeclaration).add(classBody)).or(visibilityModifier.add(Terminal.of("class")).add(qualifiedName).add(genericTypesDeclaration).add(superDeclaration).add(implementsInterfaces).add(classBody)).or(visibilityModifier.add(Terminal.of("class")).add(qualifiedName).add(genericTypesDeclaration).add(superDeclaration).add(classBody)).or(implementationModifiers.add(Terminal.of("class")).add(qualifiedName).add(genericTypesDeclaration).add(superDeclaration).add(implementsInterfaces).add(classBody)).or(implementationModifiers.add(Terminal.of("class")).add(qualifiedName).add(genericTypesDeclaration).add(superDeclaration).add(classBody)).or(Terminal.of("class").add(qualifiedName).add(genericTypesDeclaration).add(superDeclaration).add(implementsInterfaces).add(classBody)).or(Terminal.of("class").add(qualifiedName).add(genericTypesDeclaration).add(superDeclaration).add(classBody)));
        objectDeclaration.setRule(annotations.add(visibilityModifier).add(implementationModifiers).add(Terminal.of("object")).add(qualifiedName).add(superDeclaration).add(implementsInterfaces).add(classBody).or(annotations.add(visibilityModifier).add(implementationModifiers).add(Terminal.of("object")).add(qualifiedName).add(superDeclaration).add(classBody)).or(annotations.add(visibilityModifier).add(Terminal.of("object")).add(qualifiedName).add(superDeclaration).add(implementsInterfaces).add(classBody)).or(annotations.add(visibilityModifier).add(Terminal.of("object")).add(qualifiedName).add(superDeclaration).add(classBody)).or(annotations.add(implementationModifiers).add(Terminal.of("object")).add(qualifiedName).add(superDeclaration).add(implementsInterfaces).add(classBody)).or(annotations.add(implementationModifiers).add(Terminal.of("object")).add(qualifiedName).add(superDeclaration).add(classBody)).or(annotations.add(Terminal.of("object")).add(qualifiedName).add(superDeclaration).add(implementsInterfaces).add(classBody)).or(annotations.add(Terminal.of("object")).add(qualifiedName).add(superDeclaration).add(classBody)).or(visibilityModifier.add(implementationModifiers).add(Terminal.of("object")).add(qualifiedName).add(superDeclaration).add(implementsInterfaces).add(classBody)).or(visibilityModifier.add(implementationModifiers).add(Terminal.of("object")).add(qualifiedName).add(superDeclaration).add(classBody)).or(visibilityModifier.add(Terminal.of("object")).add(qualifiedName).add(superDeclaration).add(implementsInterfaces).add(classBody)).or(visibilityModifier.add(Terminal.of("object")).add(qualifiedName).add(superDeclaration).add(classBody)).or(implementationModifiers.add(Terminal.of("object")).add(qualifiedName).add(superDeclaration).add(implementsInterfaces).add(classBody)).or(implementationModifiers.add(Terminal.of("object")).add(qualifiedName).add(superDeclaration).add(classBody)).or(Terminal.of("object").add(qualifiedName).add(superDeclaration).add(implementsInterfaces).add(classBody)).or(Terminal.of("object").add(qualifiedName).add(superDeclaration).add(classBody)));
        implementsInterfaces.setRule(Terminal.of("implements").add(extendsInterfaceType));
        interfaceDeclaration.setRule(annotations.add(visibilityModifier).add(Terminal.of("interface")).add(qualifiedName).add(genericTypesDeclaration).add(extendsInterfaces).add(interfaceBody).or(annotations.add(visibilityModifier).add(Terminal.of("interface")).add(qualifiedName).add(genericTypesDeclaration).add(interfaceBody)).or(annotations.add(Terminal.of("interface")).add(qualifiedName).add(genericTypesDeclaration).add(extendsInterfaces).add(interfaceBody)).or(annotations.add(Terminal.of("interface")).add(qualifiedName).add(genericTypesDeclaration).add(interfaceBody)).or(visibilityModifier.add(Terminal.of("interface")).add(qualifiedName).add(genericTypesDeclaration).add(extendsInterfaces).add(interfaceBody)).or(visibilityModifier.add(Terminal.of("interface")).add(qualifiedName).add(genericTypesDeclaration).add(interfaceBody)).or(Terminal.of("interface").add(qualifiedName).add(genericTypesDeclaration).add(extendsInterfaces).add(interfaceBody)).or(Terminal.of("interface").add(qualifiedName).add(genericTypesDeclaration).add(interfaceBody)));
        ...
        abstractPropertyDeclaration.setRule(annotations.add(imutabilityModifier).add(visibilityModifier).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(abstractPropertyHead).or(annotations.add(imutabilityModifier).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(abstractPropertyHead)).or(annotations.add(visibilityModifier).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(abstractPropertyHead)).or(annotations.add(Identifier.instance()).add(Terminal.of(":")).add(type).add(abstractPropertyHead)).or(imutabilityModifier.add(visibilityModifier).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(abstractPropertyHead)).or(imutabilityModifier.add(Identifier.instance()).add(Terminal.of(":")).add(type).add(abstractPropertyHead)).or(visibilityModifier.add(Identifier.instance()).add(Terminal.of(":")).add(type).add(abstractPropertyHead)).or(Identifier.instance().add(Terminal.of(":")).add(type).add(abstractPropertyHead)));
        abstractPropertyHead.setRule(Terminal.of("{").add(Terminal.of("}")).or(Terminal.of("{").add(abstractPropertyMembers).add(Terminal.of("}"))));
        abstractPropertyMembers.setRule(abstractPropertyMember.or(abstractPropertyMembers.add(abstractPropertyMember)));
        abstractPropertyMember.setRule(annotations.add(visibilityModifier).add(Terminal.of("set")).add(Terminal.of(";")).or(annotations.add(Terminal.of("set")).add(Terminal.of(";"))).or(visibilityModifier.add(Terminal.of("set")).add(Terminal.of(";"))).or(Terminal.of("set").add(Terminal.of(";"))).or(annotations.add(visibilityModifier).add(Terminal.of("get")).add(Terminal.of(";")).or(annotations.add(Terminal.of("get")).add(Terminal.of(";"))).or(visibilityModifier.add(Terminal.of("get")).add(Terminal.of(";"))).or(Terminal.of("get").add(Terminal.of(";")))));
        abstractMethodDeclaration.setRule(annotations.add(visibilityModifier).add(implementationModifiers).add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")")).add(Terminal.of(":")).add(type).add(Terminal.of(";")).or(annotations.add(visibilityModifier).add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")")).add(Terminal.of(":")).add(type).add(Terminal.of(";"))).or(annotations.add(implementationModifiers).add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")")).add(Terminal.of(":")).add(type).add(Terminal.of(";"))).or(annotations.add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")")).add(Terminal.of(":")).add(type).add(Terminal.of(";"))).or(visibilityModifier.add(implementationModifiers).add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")")).add(Terminal.of(":")).add(type).add(Terminal.of(";"))).or(visibilityModifier.add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")")).add(Terminal.of(":")).add(type).add(Terminal.of(";"))).or(implementationModifiers.add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")")).add(Terminal.of(":")).add(type).add(Terminal.of(";"))).or(Identifier.instance().add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")")).add(Terminal.of(":")).add(type).add(Terminal.of(";"))).or(annotations.add(visibilityModifier).add(implementationModifiers).add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")")).add(Terminal.of(":")).add(type).add(Terminal.of(";")).or(annotations.add(visibilityModifier).add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")")).add(Terminal.of(":")).add(type).add(Terminal.of(";"))).or(annotations.add(implementationModifiers).add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")")).add(Terminal.of(":")).add(type).add(Terminal.of(";"))).or(annotations.add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")")).add(Terminal.of(":")).add(type).add(Terminal.of(";"))).or(visibilityModifier.add(implementationModifiers).add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")")).add(Terminal.of(":")).add(type).add(Terminal.of(";"))).or(visibilityModifier.add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")")).add(Terminal.of(":")).add(type).add(Terminal.of(";"))).or(implementationModifiers.add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")")).add(Terminal.of(":")).add(type).add(Terminal.of(";"))).or(Identifier.instance().add(Terminal.of("(")).add(Terminal.of(")")).add(Terminal.of(":")).add(type).add(Terminal.of(";")))));
        ...
        constructorDeclaration.setRule(annotations.add(visibilityModifier).add(implementationModifiers).add(constructorDeclarator).add(Terminal.of("(")).add(constructorFormalParameterList).add(Terminal.of(")")).add(constructorExtension).add(construtorBlock).or(annotations.add(visibilityModifier).add(implementationModifiers).add(constructorDeclarator).add(Terminal.of("(")).add(constructorFormalParameterList).add(Terminal.of(")")).add(construtorBlock)).or(annotations.add(visibilityModifier).add(implementationModifiers).add(constructorDeclarator).add(Terminal.of("(")).add(Terminal.of(")")).add(constructorExtension).add(construtorBlock)).or(annotations.add(visibilityModifier).add(implementationModifiers).add(constructorDeclarator).add(Terminal.of("(")).add(Terminal.of(")")).add(construtorBlock)).or(annotations.add(visibilityModifier).add(constructorDeclarator).add(Terminal.of("(")).add(constructorFormalParameterList).add(Terminal.of(")")).add(constructorExtension).add(construtorBlock)).or(annotations.add(visibilityModifier).add(constructorDeclarator).add(Terminal.of("(")).add(constructorFormalParameterList).add(Terminal.of(")")).add(construtorBlock)).or(annotations.add(visibilityModifier).add(constructorDeclarator).add(Terminal.of("(")).add(Terminal.of(")")).add(constructorExtension).add(construtorBlock)).or(annotations.add(visibilityModifier).add(constructorDeclarator).add(Terminal.of("(")).add(Terminal.of(")")).add(construtorBlock)).or(annotations.add(implementationModifiers).add(constructorDeclarator).add(Terminal.of("(")).add(constructorFormalParameterList).add(Terminal.of(")")).add(constructorExtension).add(construtorBlock)).or(annotations.add(implementationModifiers).add(constructorDeclarator).add(Terminal.of("(")).add(constructorFormalParameterList).add(Terminal.of(")")).add(construtorBlock)).or(annotations.add(implementationModifiers).add(constructorDeclarator).add(Terminal.of("(")).add(Terminal.of(")")).add(constructorExtension).add(construtorBlock)).or(annotations.add(implementationModifiers).add(constructorDeclarator).add(Terminal.of("(")).add(Terminal.of(")")).add(construtorBlock)).or(annotations.add(constructorDeclarator).add(Terminal.of("(")).add(constructorFormalParameterList).add(Terminal.of(")")).add(constructorExtension).add(construtorBlock)).or(annotations.add(constructorDeclarator).add(Terminal.of("(")).add(constructorFormalParameterList).add(Terminal.of(")")).add(construtorBlock)).or(annotations.add(constructorDeclarator).add(Terminal.of("(")).add(Terminal.of(")")).add(constructorExtension).add(construtorBlock)).or(annotations.add(constructorDeclarator).add(Terminal.of("(")).add(Terminal.of(")")).add(construtorBlock)).or(visibilityModifier.add(implementationModifiers).add(constructorDeclarator).add(Terminal.of("(")).add(constructorFormalParameterList).add(Terminal.of(")")).add(constructorExtension).add(construtorBlock)).or(visibilityModifier.add(implementationModifiers).add(constructorDeclarator).add(Terminal.of("(")).add(constructorFormalParameterList).add(Terminal.of(")")).add(construtorBlock)).or(visibilityModifier.add(implementationModifiers).add(constructorDeclarator).add(Terminal.of("(")).add(Terminal.of(")")).add(constructorExtension).add(construtorBlock)).or(visibilityModifier.add(implementationModifiers).add(constructorDeclarator).add(Terminal.of("(")).add(Terminal.of(")")).add(construtorBlock)).or(visibilityModifier.add(constructorDeclarator).add(Terminal.of("(")).add(constructorFormalParameterList).add(Terminal.of(")")).add(constructorExtension).add(construtorBlock)).or(visibilityModifier.add(constructorDeclarator).add(Terminal.of("(")).add(constructorFormalParameterList).add(Terminal.of(")")).add(construtorBlock)).or(visibilityModifier.add(constructorDeclarator).add(Terminal.of("(")).add(Terminal.of(")")).add(constructorExtension).add(construtorBlock)).or(visibilityModifier.add(constructorDeclarator).add(Terminal.of("(")).add(Terminal.of(")")).add(construtorBlock)).or(implementationModifiers.add(constructorDeclarator).add(Terminal.of("(")).add(constructorFormalParameterList).add(Terminal.of(")")).add(constructorExtension).add(construtorBlock)).or(implementationModifiers.add(constructorDeclarator).add(Terminal.of("(")).add(constructorFormalParameterList).add(Terminal.of(")")).add(construtorBlock)).or(implementationModifiers.add(constructorDeclarator).add(Terminal.of("(")).add(Terminal.of(")")).add(constructorExtension).add(construtorBlock)).or(implementationModifiers.add(constructorDeclarator).add(Terminal.of("(")).add(Terminal.of(")")).add(construtorBlock)).or(constructorDeclarator.add(Terminal.of("(")).add(constructorFormalParameterList).add(Terminal.of(")")).add(constructorExtension).add(construtorBlock)).or(constructorDeclarator.add(Terminal.of("(")).add(constructorFormalParameterList).add(Terminal.of(")")).add(construtorBlock)).or(constructorDeclarator.add(Terminal.of("(")).add(Terminal.of(")")).add(constructorExtension).add(construtorBlock)).or(constructorDeclarator.add(Terminal.of("(")).add(Terminal.of(")")).add(construtorBlock)));
        constructorFormalParameterList.setRule(constructorFormalParameter.or(constructorFormalParameterList.add(Terminal.of(",")).add(constructorFormalParameter)));
        constructorFormalParameter.setRule(visibilityModifier.add(imutabilityModifier).add(variableName).add(Terminal.of(":")).add(type).or(visibilityModifier.add(variableName).add(Terminal.of(":")).add(type)).or(imutabilityModifier.add(variableName).add(Terminal.of(":")).add(type)).or(variableName.add(Terminal.of(":")).add(type)));
        constructorExtension.setRule(Terminal.of("extends").add(Terminal.of("super")).add(Terminal.of("(")).add(argumentList).add(Terminal.of(")")).or(Terminal.of("extends").add(Terminal.of("super")).add(Terminal.of("(")).add(Terminal.of(")"))).or(Terminal.of("extends").add(Terminal.of("this")).add(Terminal.of("(")).add(argumentList).add(Terminal.of(")")).or(Terminal.of("extends").add(Terminal.of("this")).add(Terminal.of("(")).add(Terminal.of(")"))).or(Terminal.of("extends").add(Terminal.of("super")).add(Terminal.of(".")).add(Identifier.instance()).add(Terminal.of("(")).add(argumentList).add(Terminal.of(")")).or(Terminal.of("extends").add(Terminal.of("super")).add(Terminal.of(".")).add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")"))).or(Terminal.of("extends").add(Terminal.of("this")).add(Terminal.of(".")).add(Identifier.instance()).add(Terminal.of("(")).add(argumentList).add(Terminal.of(")")).or(Terminal.of("extends").add(Terminal.of("this")).add(Terminal.of(".")).add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")")))))));
        construtorBlock.setRule(Terminal.of(";").or(block));
        constructorDeclarator.setRule(Terminal.of("constructor").or(Terminal.of("constructor").add(Identifier.instance()).or(Terminal.of("implicit").add(Terminal.of("constructor")).or(Terminal.of("implicit").add(Terminal.of("constructor")).add(Identifier.instance())))));
        classMemberDeclaration.setRule(fieldDeclaration.or(methodDeclaration.or(constructorDeclaration.or(propertyDeclaration.or(indexerDeclaration.or(abstractIndexerDeclaration))))));
        fieldDeclaration.setRule(annotations.add(visibilityModifier).add(imutabilityModifier).add(variableName).add(Terminal.of(":")).add(type).add(Terminal.of(";")).or(annotations.add(imutabilityModifier).add(variableName).add(Terminal.of(":")).add(type).add(Terminal.of(";"))).or(visibilityModifier.add(imutabilityModifier).add(variableName).add(Terminal.of(":")).add(type).add(Terminal.of(";"))).or(imutabilityModifier.add(variableName).add(Terminal.of(":")).add(type).add(Terminal.of(";"))).or(annotations.add(visibilityModifier).add(imutabilityModifier).add(variableName).add(Terminal.of("=")).add(expression).add(Terminal.of(";")).or(annotations.add(imutabilityModifier).add(variableName).add(Terminal.of("=")).add(expression).add(Terminal.of(";"))).or(visibilityModifier.add(imutabilityModifier).add(variableName).add(Terminal.of("=")).add(expression).add(Terminal.of(";"))).or(imutabilityModifier.add(variableName).add(Terminal.of("=")).add(expression).add(Terminal.of(";"))).or(annotations.add(visibilityModifier).add(imutabilityModifier).add(variableName).add(Terminal.of(":")).add(type).add(Terminal.of("=")).add(expression).add(Terminal.of(";")).or(annotations.add(imutabilityModifier).add(variableName).add(Terminal.of(":")).add(type).add(Terminal.of("=")).add(expression).add(Terminal.of(";"))).or(visibilityModifier.add(imutabilityModifier).add(variableName).add(Terminal.of(":")).add(type).add(Terminal.of("=")).add(expression).add(Terminal.of(";"))).or(imutabilityModifier.add(variableName).add(Terminal.of(":")).add(type).add(Terminal.of("=")).add(expression).add(Terminal.of(";"))))));
        propertyDeclaration.setRule(typedPropertyDeclaration.or(nonTypedPropertyDeclaration));
        typedPropertyDeclaration.setRule(annotations.add(visibilityModifier).add(implementationModifiers).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationHead).or(annotations.add(visibilityModifier).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationHead)).or(annotations.add(implementationModifiers).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationHead)).or(annotations.add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationHead)).or(visibilityModifier.add(implementationModifiers).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationHead)).or(visibilityModifier.add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationHead)).or(implementationModifiers.add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationHead)).or(Identifier.instance().add(Terminal.of(":")).add(type).add(propertyDeclarationHead)).or(annotations.add(visibilityModifier).add(implementationModifiers).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationHead).add(Terminal.of("=")).add(expression).add(Terminal.of(";")).or(annotations.add(visibilityModifier).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationHead).add(Terminal.of("=")).add(expression).add(Terminal.of(";"))).or(annotations.add(implementationModifiers).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationHead).add(Terminal.of("=")).add(expression).add(Terminal.of(";"))).or(annotations.add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationHead).add(Terminal.of("=")).add(expression).add(Terminal.of(";"))).or(visibilityModifier.add(implementationModifiers).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationHead).add(Terminal.of("=")).add(expression).add(Terminal.of(";"))).or(visibilityModifier.add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationHead).add(Terminal.of("=")).add(expression).add(Terminal.of(";"))).or(implementationModifiers.add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationHead).add(Terminal.of("=")).add(expression).add(Terminal.of(";"))).or(Identifier.instance().add(Terminal.of(":")).add(type).add(propertyDeclarationHead).add(Terminal.of("=")).add(expression).add(Terminal.of(";")))));
        nonTypedPropertyDeclaration.setRule(annotations.add(visibilityModifier).add(implementationModifiers).add(Identifier.instance()).add(propertyDeclarationHead).or(annotations.add(visibilityModifier).add(Identifier.instance()).add(propertyDeclarationHead)).or(annotations.add(implementationModifiers).add(Identifier.instance()).add(propertyDeclarationHead)).or(annotations.add(Identifier.instance()).add(propertyDeclarationHead)).or(visibilityModifier.add(implementationModifiers).add(Identifier.instance()).add(propertyDeclarationHead)).or(visibilityModifier.add(Identifier.instance()).add(propertyDeclarationHead)).or(implementationModifiers.add(Identifier.instance()).add(propertyDeclarationHead)).or(Identifier.instance().add(propertyDeclarationHead)).or(annotations.add(visibilityModifier).add(implementationModifiers).add(Identifier.instance()).add(propertyDeclarationHead).add(Terminal.of("=")).add(expression).add(Terminal.of(";")).or(annotations.add(visibilityModifier).add(Identifier.instance()).add(propertyDeclarationHead).add(Terminal.of("=")).add(expression).add(Terminal.of(";"))).or(annotations.add(implementationModifiers).add(Identifier.instance()).add(propertyDeclarationHead).add(Terminal.of("=")).add(expression).add(Terminal.of(";"))).or(annotations.add(Identifier.instance()).add(propertyDeclarationHead).add(Terminal.of("=")).add(expression).add(Terminal.of(";"))).or(visibilityModifier.add(implementationModifiers).add(Identifier.instance()).add(propertyDeclarationHead).add(Terminal.of("=")).add(expression).add(Terminal.of(";"))).or(visibilityModifier.add(Identifier.instance()).add(propertyDeclarationHead).add(Terminal.of("=")).add(expression).add(Terminal.of(";"))).or(implementationModifiers.add(Identifier.instance()).add(propertyDeclarationHead).add(Terminal.of("=")).add(expression).add(Terminal.of(";"))).or(Identifier.instance().add(propertyDeclarationHead).add(Terminal.of("=")).add(expression).add(Terminal.of(";")))));
        propertyDeclarationHead.setRule(Terminal.of("{").add(Terminal.of("}")).or(Terminal.of("{").add(propertyMembers).add(Terminal.of("}"))));
        propertyMembers.setRule(propertyMember.or(propertyMembers.add(propertyMember)));
        propertyMember.setRule(annotations.add(visibilityModifier).add(Terminal.of("get")).add(Terminal.of(";")).or(annotations.add(Terminal.of("get")).add(Terminal.of(";"))).or(visibilityModifier.add(Terminal.of("get")).add(Terminal.of(";"))).or(Terminal.of("get").add(Terminal.of(";"))).or(annotations.add(visibilityModifier).add(Terminal.of("get")).add(Terminal.of("{")).add(blockStatements).add(Terminal.of("}")).or(annotations.add(Terminal.of("get")).add(Terminal.of("{")).add(blockStatements).add(Terminal.of("}"))).or(visibilityModifier.add(Terminal.of("get")).add(Terminal.of("{")).add(blockStatements).add(Terminal.of("}"))).or(Terminal.of("get").add(Terminal.of("{")).add(blockStatements).add(Terminal.of("}"))).or(annotations.add(visibilityModifier).add(Terminal.of("set")).add(Terminal.of(";")).or(annotations.add(Terminal.of("set")).add(Terminal.of(";"))).or(visibilityModifier.add(Terminal.of("set")).add(Terminal.of(";"))).or(Terminal.of("set").add(Terminal.of(";"))).or(annotations.add(visibilityModifier).add(Terminal.of("set")).add(Terminal.of("(")).add(Identifier.instance()).add(Terminal.of(")")).add(Terminal.of("{")).add(blockStatements).add(Terminal.of("}")).or(annotations.add(Terminal.of("set")).add(Terminal.of("(")).add(Identifier.instance()).add(Terminal.of(")")).add(Terminal.of("{")).add(blockStatements).add(Terminal.of("}"))).or(visibilityModifier.add(Terminal.of("set")).add(Terminal.of("(")).add(Identifier.instance()).add(Terminal.of(")")).add(Terminal.of("{")).add(blockStatements).add(Terminal.of("}"))).or(Terminal.of("set").add(Terminal.of("(")).add(Identifier.instance()).add(Terminal.of(")")).add(Terminal.of("{")).add(blockStatements).add(Terminal.of("}")))))));
        indexerDeclaration.setRule(annotations.add(visibilityModifier).add(implementationModifiers).add(Terminal.of("[")).add(formalParameterList).add(Terminal.of("]")).add(Terminal.of(":")).add(type).add(propertyDeclarationHead).or(annotations.add(visibilityModifier).add(Terminal.of("[")).add(formalParameterList).add(Terminal.of("]")).add(Terminal.of(":")).add(type).add(propertyDeclarationHead)).or(annotations.add(implementationModifiers).add(Terminal.of("[")).add(formalParameterList).add(Terminal.of("]")).add(Terminal.of(":")).add(type).add(propertyDeclarationHead)).or(annotations.add(Terminal.of("[")).add(formalParameterList).add(Terminal.of("]")).add(Terminal.of(":")).add(type).add(propertyDeclarationHead)).or(visibilityModifier.add(implementationModifiers).add(Terminal.of("[")).add(formalParameterList).add(Terminal.of("]")).add(Terminal.of(":")).add(type).add(propertyDeclarationHead)).or(visibilityModifier.add(Terminal.of("[")).add(formalParameterList).add(Terminal.of("]")).add(Terminal.of(":")).add(type).add(propertyDeclarationHead)).or(implementationModifiers.add(Terminal.of("[")).add(formalParameterList).add(Terminal.of("]")).add(Terminal.of(":")).add(type).add(propertyDeclarationHead)).or(Terminal.of("[").add(formalParameterList).add(Terminal.of("]")).add(Terminal.of(":")).add(type).add(propertyDeclarationHead)));
        abstractIndexerDeclaration.setRule(annotations.add(visibilityModifier).add(implementationModifiers).add(Terminal.of("[")).add(formalParameterList).add(Terminal.of("]")).add(Terminal.of(":")).add(type).add(abstractPropertyHead).or(annotations.add(visibilityModifier).add(Terminal.of("[")).add(formalParameterList).add(Terminal.of("]")).add(Terminal.of(":")).add(type).add(abstractPropertyHead)).or(annotations.add(implementationModifiers).add(Terminal.of("[")).add(formalParameterList).add(Terminal.of("]")).add(Terminal.of(":")).add(type).add(abstractPropertyHead)).or(annotations.add(Terminal.of("[")).add(formalParameterList).add(Terminal.of("]")).add(Terminal.of(":")).add(type).add(abstractPropertyHead)).or(visibilityModifier.add(implementationModifiers).add(Terminal.of("[")).add(formalParameterList).add(Terminal.of("]")).add(Terminal.of(":")).add(type).add(abstractPropertyHead)).or(visibilityModifier.add(Terminal.of("[")).add(formalParameterList).add(Terminal.of("]")).add(Terminal.of(":")).add(type).add(abstractPropertyHead)).or(implementationModifiers.add(Terminal.of("[")).add(formalParameterList).add(Terminal.of("]")).add(Terminal.of(":")).add(type).add(abstractPropertyHead)).or(Terminal.of("[").add(formalParameterList).add(Terminal.of("]")).add(Terminal.of(":")).add(type).add(abstractPropertyHead)));
        type.setRule(nonNullType.or(nonNullType.add(Terminal.of("?"))));
        nonNullType.setRule(Identifier.instance().or(Identifier.instance().add(Terminal.of("<")).add(parametricTypes).add(Terminal.of(">")).or(Terminal.of("(").add(tupleTypes).add(Terminal.of(")")))));
        ...
        methodDeclaration.setRule(methodHeader.add(Terminal.of(":")).add(type).add(methodBody).or(methodHeader.add(Terminal.of(":")).add(type).add(Terminal.of(";")).or(methodHeader.add(Terminal.of(":")).add(type).add(Terminal.of("=>")).add(expression).add(Terminal.of(";")).or(methodHeader.add(Terminal.of("{")).add(blockStatements).add(Terminal.of("}")).or(methodHeader.add(Terminal.of("=>")).add(expression).add(Terminal.of(";")))))));
        methodHeader.setRule(annotations.add(visibilityModifier).add(implementationModifiers).add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")")).or(annotations.add(visibilityModifier).add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")"))).or(annotations.add(implementationModifiers).add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")"))).or(annotations.add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")"))).or(visibilityModifier.add(implementationModifiers).add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")"))).or(visibilityModifier.add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")"))).or(implementationModifiers.add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")"))).or(Identifier.instance().add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")"))).or(annotations.add(visibilityModifier).add(implementationModifiers).add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")")).or(annotations.add(visibilityModifier).add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")"))).or(annotations.add(implementationModifiers).add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")"))).or(annotations.add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")"))).or(visibilityModifier.add(implementationModifiers).add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")"))).or(visibilityModifier.add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")"))).or(implementationModifiers.add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")"))).or(Identifier.instance().add(Terminal.of("(")).add(Terminal.of(")")))));
        ...
        formalParameter.setRule(variableName.add(Terminal.of(":")).add(type));
        ...
        leftHandSide.setRule(fieldAccess.or(arrayAccess));
        ...
        iterationType.setRule(variableName.or(Terminal.of("val").add(variableName)));
        ifThenStatement.setRule(Terminal.of("if").add(Terminal.of("(")).add(expression).add(Terminal.of(")")).add(block).or(Terminal.of("if").add(Terminal.of("(")).add(expression).add(Terminal.of(")")).add(block).add(Terminal.of("else")).add(elseOptions)));
        elseOptions.setRule(block.or(ifThenStatement));
        ...
        inclusiveOrExpression.setRule(exclusiveOrExpression.or(inclusiveOrExpression.add(Terminal.of("|")).add(exclusiveOrExpression)));
        ...
        equalityOperator.setRule(Terminal.of("==").or(Terminal.of("!=").or(Terminal.of("===").or(Terminal.of("!==").or(Terminal.of("<=>"))))));
        relationalExpression.setRule(shiftExpression.or(relationalExpression.add(compareOperator).add(shiftExpression).or(relationalExpression.add(Terminal.of("is")).add(typeObject))));
        typeObject.setRule(Identifier.instance());
        ...
        postfixExpression.setRule(primary.or(postincrementExpression.or(postdecrementExpression)));
        ...
        classInstanceCreationExpression.setRule(Terminal.of("new").add(type).add(Terminal.of("(")).add(argumentList).add(Terminal.of(")")).or(Terminal.of("new").add(type).add(Terminal.of("(")).add(Terminal.of(")")).or(Terminal.of("new").add(type).add(Terminal.of(".")).add(Identifier.instance()).add(Terminal.of("(")).add(argumentList).add(Terminal.of(")")).or(Terminal.of("new").add(type).add(Terminal.of(".")).add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")"))))));
        argumentList.setRule(expression.or(argumentList.add(Terminal.of(",")).add(expression)));
        methodInvocation.setRule(primary.add(Terminal.of(".")).add(Identifier.instance()).add(Terminal.of("(")).add(argumentList).add(Terminal.of(")")).or(primary.add(Terminal.of(".")).add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")"))).or(Identifier.instance().add(Terminal.of("(")).add(argumentList).add(Terminal.of(")")).or(Identifier.instance().add(Terminal.of("(")).add(Terminal.of(")")))));
        literal.setRule(numberLiteral.or(booleanLiteral.or(stringLiteral.or(nullLiteral.or(noneLiteral.or(arrayInitializer.or(tupleInitializer.or(mapInitializer))))))));
        arrayInitializer.setRule(Terminal.of("[").add(arrayInitializerVariables).add(Terminal.of("]")));
        arrayInitializerVariables.setRule(expression.or(arrayInitializerVariables.add(Terminal.of(",")).add(expression)));
        tupleInitializer.setRule(Terminal.of("(").add(tupleInitializerVariables).add(Terminal.of(")")).or(Terminal.of("(").add(Terminal.of(")"))));
        tupleInitializerVariables.setRule(expression.or(tupleInitializerVariables.add(Terminal.of(",")).add(expression)));
        ...
        mapInitializerPair.setRule(expression.add(Terminal.of(":")).add(expression));
        ...
        noneLiteral.setRule(Terminal.of("none"));
