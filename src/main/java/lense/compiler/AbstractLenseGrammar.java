...
public abstract class AbstractLenseGrammar extends AbstractGrammar {
	...
	protected NonTerminal defineGrammar() {
		...
		constructorFormalParameter.setRule(imutabilityModifier.add(visibilityModifier).add(variableName).add(Terminal.of(":")).add(type).or(imutabilityModifier.add(variableName).add(Terminal.of(":")).add(type)).or(visibilityModifier.add(variableName).add(Terminal.of(":")).add(type)).or(variableName.add(Terminal.of(":")).add(type)));
		...
		statement.setRule(expressionStatement.or(whileStatement.or(forStatement.or(ifThenStatement.or(switchStatement.or(returnStatement.or(breakStatement.or(continueStatement.or(tryStatement)))))))));
