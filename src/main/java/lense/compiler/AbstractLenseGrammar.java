...
public abstract class AbstractLenseGrammar extends AbstractGrammar {
	...
	protected NonTerminal defineGrammar() {
		...
		NonTerminal propertyDeclarationInit = addNonTerminal(NonTerminal.of("propertyDeclarationInit"));
		...
		classMemberDeclaration.setRule(methodDeclaration.or(constructorDeclaration.or(propertyDeclaration.or(indexerDeclaration.or(abstractIndexerDeclaration)))));
		propertyDeclaration.setRule(typedPropertyDeclaration.or(nonTypedPropertyDeclaration));
		typedPropertyDeclaration.setRule(annotations.add(visibilityModifier).add(implementationModifiers).add(imutabilityModifier).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationInit).or(annotations.add(visibilityModifier).add(implementationModifiers).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationInit)).or(annotations.add(visibilityModifier).add(imutabilityModifier).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationInit)).or(annotations.add(visibilityModifier).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationInit)).or(annotations.add(implementationModifiers).add(imutabilityModifier).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationInit)).or(annotations.add(implementationModifiers).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationInit)).or(annotations.add(imutabilityModifier).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationInit)).or(annotations.add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationInit)).or(visibilityModifier.add(implementationModifiers).add(imutabilityModifier).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationInit)).or(visibilityModifier.add(implementationModifiers).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationInit)).or(visibilityModifier.add(imutabilityModifier).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationInit)).or(visibilityModifier.add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationInit)).or(implementationModifiers.add(imutabilityModifier).add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationInit)).or(implementationModifiers.add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationInit)).or(imutabilityModifier.add(Identifier.instance()).add(Terminal.of(":")).add(type).add(propertyDeclarationInit)).or(Identifier.instance().add(Terminal.of(":")).add(type).add(propertyDeclarationInit)));
		nonTypedPropertyDeclaration.setRule(annotations.add(visibilityModifier).add(implementationModifiers).add(imutabilityModifier).add(Identifier.instance()).add(propertyDeclarationInit).or(annotations.add(visibilityModifier).add(implementationModifiers).add(Identifier.instance()).add(propertyDeclarationInit)).or(annotations.add(visibilityModifier).add(imutabilityModifier).add(Identifier.instance()).add(propertyDeclarationInit)).or(annotations.add(visibilityModifier).add(Identifier.instance()).add(propertyDeclarationInit)).or(annotations.add(implementationModifiers).add(imutabilityModifier).add(Identifier.instance()).add(propertyDeclarationInit)).or(annotations.add(implementationModifiers).add(Identifier.instance()).add(propertyDeclarationInit)).or(annotations.add(imutabilityModifier).add(Identifier.instance()).add(propertyDeclarationInit)).or(annotations.add(Identifier.instance()).add(propertyDeclarationInit)).or(visibilityModifier.add(implementationModifiers).add(imutabilityModifier).add(Identifier.instance()).add(propertyDeclarationInit)).or(visibilityModifier.add(implementationModifiers).add(Identifier.instance()).add(propertyDeclarationInit)).or(visibilityModifier.add(imutabilityModifier).add(Identifier.instance()).add(propertyDeclarationInit)).or(visibilityModifier.add(Identifier.instance()).add(propertyDeclarationInit)).or(implementationModifiers.add(imutabilityModifier).add(Identifier.instance()).add(propertyDeclarationInit)).or(implementationModifiers.add(Identifier.instance()).add(propertyDeclarationInit)).or(imutabilityModifier.add(Identifier.instance()).add(propertyDeclarationInit)).or(Identifier.instance().add(propertyDeclarationInit)));
		propertyDeclarationInit.setRule(Terminal.of(";").or(propertyDeclarationHead.or(Terminal.of("=>").add(expression).add(Terminal.of(";")).or(Terminal.of("=").add(literal).add(Terminal.of(";")).or(Terminal.of("=").add(literal).add(propertyDeclarationHead).add(Terminal.of(";")))))));
		propertyDeclarationHead.setRule(Terminal.of("{").add(propertyMembers).add(Terminal.of("}")));
		...
		statementExpression.setRule(assignment.or(expression));
		...
		iterationType.setRule(variableName.or(Terminal.of("let").add(variableName)));
		...
		switchStatement.setRule(Terminal.of("switch").add(Terminal.of("(")).add(leftHandSide).add(Terminal.of(")")).add(switchBlock));
		...
		expression.setRule(variableName.or(lambdaExpression));
		...
		additiveOperator.setRule(Terminal.of("+").or(Terminal.of("++").or(Terminal.of("-").or(Terminal.of("&+").or(Terminal.of("&-"))))));
