...
public class TestComplex {
	...
	public void testComplexAbs () {
		Imaginary img = Imaginary.valueOf(Rational.constructor(NativeNumberFactory.newNatural(4)));
		Natural n = NativeNumberFactory.newNatural(3);
		Real r = Rational.constructor(n);
		...
		Real x = Rational.constructor(NativeNumberFactory.newNatural(16));
