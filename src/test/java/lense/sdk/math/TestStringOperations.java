...
public class TestStringOperations {
	...
	List<String> strings = List.of(
			NativeString.valueOfNative("The brown dog jumped over the lazy fox"),
			NativeString.valueOfNative("The brown dog").concat(NativeString.valueOfNative(" jumped over")).concat(NativeString.valueOfNative(" the lazy fox")),
			NativeString.valueOfNative("The brown dog jumped over the lazy fox at night").subString(Natural64.valueOfNative(0) ,Natural64.valueOfNative(38))
			);
