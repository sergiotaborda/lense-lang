...
- [ ] optimize private properties to native fields.
- [ ] optimize common patterns `real + imaginary` to `new Complex(real,imaginary)` 
- [x] optimize common patterns `1/x` to `x.invert()`  
