...
- [ ] verifiy variable was already defined

== Language Features

- [ ] understand that -0.0 may be a different thing than 0.0 if the taget is Float. Also 0.0.symetric() == -0.0 in Float and that -0.0 = new Float32(0.0).symetric()  but not  -0.0 =/= new Float32(new Rational(0.0)); 
...
- [ ] Annotation
- [ ] Enhancements -> useful for operations on numbers of different types. enhancements can be native
* [x] methods
* [ ] constructors
...
- [x] Define Selaed Type Hierarchies types like: `abstract class Boolean is true , false`
* [x] Define sealed case classes,  
* [x] Define sealed case objects and enums  
* [ ] Define sealed interfaces  
- [ ] Define Annotations
- [ ] Define Enhancements (usefull for operations on numbers of different types. enhancements can be native)
* [x] Define enhancement methods
* [ ] Define enhancement named contructors
...
* [/] erase numeric values to they primitive conterparts when bound limits are kown (like in ranges). Done for int
