...
public final class NativeNumberFactory {
    ...
    public static int compareNumbers(Number a, Number b) {
        ...
        if (a instanceof Rational){
            ...
            ga = a instanceof BigDecimalConvertable ? ((BigDecimalConvertable) a).toBigDecimal() : new java.math.BigDecimal(a.toString());
        }
        ...
        if (b instanceof Rational){
            ...
            gb = b instanceof BigDecimalConvertable ? ((BigDecimalConvertable) b).toBigDecimal() : new java.math.BigDecimal(b.toString());
        }
